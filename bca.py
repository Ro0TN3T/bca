...
class BCA(object):
    ...
    def __login(self):
        ...
        body = "value(user_id)=" + self.__userid+"&value(pswd)=" + self.__pwd + \
            ...
            "&user_ip=" + self.__getIp() + "&value(mobile)=true&value(browser_info)=Mozilla/5.0 (Linux; Android 12; CPH2159) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36&mobile=true"
        r = requests.post(api, data=body, headers={
            "Origin": "https://m.klikbca.com",
            "Content-Type": "application/x-www-form-urlencoded",
            "User-Agent": "Mozilla/5.0 (Linux; Android 12; CPH2159) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Mobile Safari/537.36",
...
print(" Created By : @Ro0T_N3T ".center(30, "="))
print("\nNote: ")
